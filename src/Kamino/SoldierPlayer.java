...
public class SoldierPlayer extends BasePlayer {
    ...
    private float ARCHON_BONUS_SCORE = 0.3f;                    //Increasing this makes it more likely to go after archons
                ...
                if (active_alert){
                    if (target != null) {
                        ...
                        if (target != ENEMY_ARCHON_LOCATION || MY_LOCATION.distanceTo(next_target) < MY_LOCATION.distanceTo(target)) {
                            //I'll rather go disrupt enemy's farming than respond to contactrep/spotrep if I'm close
