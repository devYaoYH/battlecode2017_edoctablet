...
public class TankPlayer extends BasePlayer {
    ...
    /*
    Tanks are exactly similar to soldiers aside from 2 main differences:
        --> They don't dodge bullets (too large, too slow - no point)
        --> Custom canMoveTank() function as rc.canMove() for tanks returned true for friendly/neutral trees
    Aside from that, target/report tuning is slightly different from soldiers as well (tanks don't get bonus score
    rushing back to defend, too slow...)

    Overall, tanks in this year's competition was a huge waste of potential >.< They could be sooooo much more...
    */
