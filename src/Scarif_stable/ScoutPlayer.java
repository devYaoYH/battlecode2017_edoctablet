...
public class ScoutPlayer extends BasePlayer {
    ...
    /*
    DEPRECIATED CODE:
        After sprint tournament, when scouts HP went from 20 -> 10 and attack power from 1 -> 0.5
        Scouts just weren't that effective anymore as an offensive unit, so we suspended further developments on this front
    */
