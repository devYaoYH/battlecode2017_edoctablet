...
public class BasePlayer {
    ...
    static final float PENTAD_EFFECTIVE_DISTANCE = 3f;		    //(1/tan(7.5deg)) Such that at least 2 shots will hit a target with radius 1
...
//        rc.setIndicatorDot(MY_LOCATION.add(initDir, MOVEMENT_SCANNING_DISTANCE), 0, 255, 0);
    ...
    private MapLocation readLatestEnemyArchonLocation() throws GameActionException {
        return intToMapLocation(rc.readBroadcast(ENEMY_ARCHON_CHANNEL));
    }
