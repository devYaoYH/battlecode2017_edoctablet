...
public class SoldierPlayer extends BasePlayer {
    ...
    static float movement_stuck_radius = RobotType.SOLDIER.strideRadius/8*stuckRounds;       //Stuck distance for 17 rounds
    ...
    private void run() {
        ...
        if (inCombat){
            ...
            if (nearestdist <= SOLDIER_MICRO_DIST || nearbyBullets.length > 0) {
                ...
                moveToTargetExperimental(MY_LOCATION, SOLDIER_CHASING_GRANULARITY, search_dir, am_stuck, SLUG);
    ...
    private void soldierCombatMove(RobotInfo targetedEnemy, RobotInfo[] nearbyEnemies, BulletInfo[] nearbyBullets){
        ...
        if (targetedEnemy != null && targetedEnemy.type == RobotType.ARCHON && rc.getTeamBullets() < 53){
            should_fire_pentad = false;
            should_fire_triad = false;
        }
        ...
        if (targetedEnemy.type == RobotType.GARDENER || targetedEnemy.type == RobotType.ARCHON){
            ...
            moveToTargetExperimental(MY_LOCATION, SENSOR_GRANULARITY, search_dir, am_stuck, 1);
        }
        else {
            ...
            if (finalDir != null) {
                ...
                moveToTargetExperimental(MY_LOCATION, SOLDIER_CHASING_GRANULARITY, search_dir, am_stuck, 1);
            }
        }
