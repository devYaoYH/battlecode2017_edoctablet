...
public class Broadcaster {
    ...
    static final int CONTACTREP_RELEVANCE = 10;
    static final int SITREP_RELEVANCE = 50;
    ...
    static final int BROADCASTER_INITIALIZE_X_upper = 1998;
    static final int BROADCASTER_INITIALIZE_Y_upper = 1999;
    ...
    public int[] readGrid(MapLocation loc) throws GameActionException {
        ...
        int x = locGrid[0];
        int y = locGrid[1];
        if (x > 99 || y > 99 || x < 0 || y < 0) return null;
    ...
    public int grid_to_channel(int[] gridCoords){
        int[] cur_grid = {gridCoords[0], gridCoords[1]};
        cur_grid[0] -= OFFSET_X;
        cur_grid[1] -= OFFSET_Y;
    ...
    public int location_to_channel(MapLocation loc){
        int x_coord = Math.round(loc.x/GRID_SIZE);
        int y_coord = Math.round(loc.y/GRID_SIZE);
        x_coord -= OFFSET_X;
        y_coord -= OFFSET_Y;
